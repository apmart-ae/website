export const metadata = { title: "Privacy Policy â€” APMART.AE" };
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
        {[
          ["1. Information We Collect", "We collect information you provide directly (name, email, phone, address), information generated during purchases (order history, payment method type â€” never full card numbers), and technical data (IP address, browser type, device) via cookies and analytics."],
          ...
          ["9. Contact", "For privacy enquiries: privacy@apmart.ae or +971 52 505 3425 (attn: Data Protection)."],
        ].map(([title, body]) => (
